...
wget github.com/seth42sp/SincAI/tree/SincAI/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget github.com/seth42sp/SincAI/tree/SincAI/sincarm/sshplus.zip.002 > /dev/null 2>&1
wget github.com/seth42sp/SincAI/tree/SincAI/sincarm/sshplus.zip.003 > /dev/null 2>&1
